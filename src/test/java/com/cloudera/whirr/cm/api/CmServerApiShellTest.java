...
public class CmServerApiShellTest implements BaseTest {
  ...
  public void testGetValid1() throws CmServerApiException {
    Assert.assertFalse(((Boolean) CmServerApiShell.get().host("host-1").cluster(cluster)
  ...
  public void testGetValid2() throws CmServerApiException {
    Assert
        .assertFalse(((Boolean) CmServerApiShell
            .get()
            .arguments(
  ...
  public void testGetException1() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException2() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host(""));
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException3() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("").port(""));
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException4() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").port(""));
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException5() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").command(""));
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException6() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException7() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").command("").execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException8() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").command("some-rubbish").execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException9() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").command("client").execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException10() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").cluster(cluster).execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException11() throws CmServerApiException {
    Assert.assertNotNull(CmServerApiShell.get().host("host-1").client(DIR_CLIENT_CONFIG.getAbsolutePath()).execute());
  }

  @Test(expected = CmServerApiException.class)
  public void testGetException12() throws CmServerApiException {
    Assert.assertFalse(((Boolean) CmServerApiShell.get()
  ...
  public void testProcessArgumnetsValid1() throws CmServerApiException {
    Assert.assertEquals(0, CmServerApiShell.argumentsPreProcess(new String[] {}).size());
    Assert.assertEquals(1, CmServerApiShell.argumentsPreProcess(new String[] { "--client", "/tmp/whirr.properties" })
        .size());
    Assert.assertEquals(1, CmServerApiShell.argumentsPreProcess(new String[] { "--client", "/tmp/whirr.properties" })
        .size());
    Assert.assertEquals(2,
        CmServerApiShell.argumentsPreProcess(new String[] { "--client", "/tmp/whirr.properties", "--host", "host-1" })
            .size());
  }

  @Test(expected = CmServerApiException.class)
  public void testProcessArgumentsException1() throws CmServerApiException {
    Assert.assertEquals(1, CmServerApiShell.argumentsPreProcess(new String[] { "--client" }).size());
  }

  @Test(expected = CmServerApiException.class)
  public void testProcessArgumentsException2() throws CmServerApiException {
    Assert.assertEquals(2,
        CmServerApiShell.argumentsPreProcess(new String[] { "--client", "/tmp/whirr.properties", "host" }).size());
  }
  ...
  public void testProcessArgumentsException4() throws CmServerApiException {
    Assert.assertEquals(1, CmServerApiShell.argumentsPreProcess(new String[] { "", "" }).size());
  }
